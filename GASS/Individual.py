...
class Indivi:
    ...
    def Eval_Accuracy(self,batch_xs, batch_ys):
        temp = np.array((self.gene[0,0:768]).reshape(128,6))
        temp2 = np.array(self.gene[0,768:774])
    ...
    def Finish(self, best_gene,test_input,test_output):
        print(best_gene)
        temp = np.array((best_gene[0,0:768]).reshape(128,6))
        temp2 = np.array(best_gene[0,768:774])
        # print("--------------------")
        # print(test_input)
        # print(test_output)
        # print(temp.shape)
