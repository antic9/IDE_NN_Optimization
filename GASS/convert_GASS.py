...
class convert_GASS:
    def Convert():
        ...
        #numpy.arrayに変換
        GASS_input = np.array(GASS_input)
        GASS_output = np.array(GASS_output)
        GASS_input_test = np.array(GASS_input_test)
        GASS_output_test = np.array(GASS_output_test)
        
        # print("gas_input", GASS_input[0][0])
        # print(GASS_output)
