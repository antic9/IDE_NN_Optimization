...
if __name__ == '__main__':
    ...
    for i in range(GENERATION):
        ...
        de.Best_plot(Bestindividual,Bestgene,Bestaccuracy,QSAR_input_test,QSAR_output_test)
    ...
    if(Method=="jDE"):
        ...
        with open('ide_crossentropy_A'+name_str+'.csv', 'a',newline='') as f:
            w = csv.writer(f)
            w = w.writerow(Bestindividual)
    indiv.Finish(Bestgene[i],QSAR_input_test,QSAR_output_test)
    print(Method)
    print(de)
